...
sectionOsc.setPosition(FIRST, FIRST, 2, PAD_X, PAD_Y)
...
sectionStyle.setPosition(THIRD, FIRST, 1, PAD_X, (0, PAD_Y))
Radiobutton(sectionStyle.getSection(), variable=group2, image=monoIcon, value=1, indicatoron=0, width=WIDTH_IMG, height=HEIGHT_RB, command=lambda: [synth.setStyle(1)]).grid(row=FIRST,column=FIRST, padx=(6,0), pady=(PAD_Y_W, 0))
Radiobutton(sectionStyle.getSection(), variable=group2, image=duoIcon, value=2, indicatoron=0, width=WIDTH_IMG, height=HEIGHT_RB, command=lambda: [synth.setStyle(2)]).grid(row=FIRST,column=SECOND, padx=(5,0), pady=(PAD_Y_W, 0))
Radiobutton(sectionStyle.getSection(), variable=group2, image=trioIcon, value=3, indicatoron=0, width=WIDTH_IMG, height=HEIGHT_RB, command=lambda: [synth.setStyle(3)]).grid(row=FIRST,column=THIRD, padx=(5,0), pady=PAD_Y_W)
Radiobutton(sectionStyle.getSection(), variable=group2, image=quattroIcon, value=4, indicatoron=0, width=WIDTH_IMG, height=HEIGHT_RB, command=lambda: [synth.setStyle(4)]).grid(row=FIRST,column=FOURTH, padx=(5,7), pady=PAD_Y_W)
...
sectionChunk.setPosition(FOURTH, FIRST, 1, PAD_X, (0, PAD_Y))
...
sectionFilter.setPosition(THIRD, SECOND, 2, (0, PAD_X), 0)
